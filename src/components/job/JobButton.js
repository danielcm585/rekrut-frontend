                      ...
                      canReview && (
                        <>
                          <Flex>
                            ...
                            <Button w={!isBigScreen && "100%"} ml="2" pl="10" pr="10" borderRadius="50" bgColor="#FF8450"
                              onClick={() => {
                                {/*TODO: Edit job */}
                                console.log("EDIT")
                              }}> 
            ...
            <>
              {
                (user.role == "worker") ? (
                  <>
                    {
                      canReview && (
                        <Button w={!isBigScreen && "100%"} pl="10" pr="10" borderRadius="50" bgColor="#FF8450" isDisabled>
